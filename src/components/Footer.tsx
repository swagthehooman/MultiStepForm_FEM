...
export default function Footer() {
    ...
    return (
        <div className={`w-full flex justify-between`}>
            ...
            <button className={`bg-primaryMarineBlue text-neutralAlabaster pl-4 pr-4 pt-2 pb-2 rounded-md cursor-pointer ${step === 1 ? 'ml-auto' : ''}`} onClick={handleNextStep}>Next Step</button>
        </div>
    )
}
